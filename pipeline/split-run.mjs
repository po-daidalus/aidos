...
const CITIES = ['Düsseldorf', 'Dresden', 'Stuttgart', 'Nürnberg', 'Hannover', 'Bremen', 'Essen', 'Dortmund', 'Bochum', 'Duisburg', 'München', 'Berlin', 'Hamburg', 'Köln', 'Leipzig', 'Frankfurt am Main', 'Wuppertal', 'Bielefeld', 'Bonn', 'Münster', 'Mannheim', 'Karlsruhe', 'Augsburg', 'Wiesbaden', 'Mönchengladbach'];
...
const GEO = {
  ...
  'Duisburg': [51.35, 51.5, 6.65, 6.85],
  'Wuppertal': [51.16, 51.31, 7.02, 7.31], 'Bielefeld': [51.94, 52.12, 8.37, 8.66], 'Bonn': [50.63, 50.78, 7.02, 7.21],
  'Münster': [51.87, 52.06, 7.52, 7.77], 'Mannheim': [49.41, 49.56, 8.41, 8.59], 'Karlsruhe': [48.94, 49.09, 8.28, 8.5],
  'Augsburg': [48.25, 48.46, 10.75, 10.98], 'Wiesbaden': [50.02, 50.15, 8.14, 8.34], 'Mönchengladbach': [51.1, 51.27, 6.31, 6.52], 'München': [48.0, 48.3, 11.3, 11.8], 'Berlin': [52.3, 52.7, 13.1, 13.8],
